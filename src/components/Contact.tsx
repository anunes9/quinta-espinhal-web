        ...
        >
          ...
          <div className="mt-12 flex flex-col items-center justify-center gap-8 md:flex-row">
            <a
              ...
              className="flex items-center gap-3 font-body text-sm tracking-wider text-foreground transition-colors hover:text-accent"
            >
              <Phone
                className="h-4 w-4"
                strokeWidth={1.5}
          ...
          <div className="mt-12">
            <a
              href="https://www.quintadoespinhal.pt/pedido-de-reserva/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-primary px-12 py-4 font-body text-xs tracking-[0.25em] uppercase text-primary-foreground transition-all hover:opacity-90"
            >
              Pedido de Reserva
            </a>
          </div>
