        ...
        >
          ...
          <div className="mt-12">
            <a
              ...
              className="inline-block bg-primary px-12 py-4 font-body text-xs tracking-[0.25em] uppercase text-primary-foreground transition-all duration-300 hover:opacity-90"
            >
              Pedido de Reserva
            </a>
          </div>
